...
class ManagerStepVisitor : public octopus::SteppableVisitor
{
public:
	ManagerStepVisitor(GameManager &manager_p, octopus::State const *state_p)
		: _manager(manager_p), _state(state_p) {}
	...
	virtual void visit(octopus::CommandMoveStepSinceUpdateIncrementStep const *) override {}
	...
	virtual void visit(octopus::TeamVisionStep const *) override {}
...
/// @brief Apply ManagerStepVisitor to step
void applyVisitor(GameManager &controller_p, octopus::State const &state_p, octopus::Step const &step_p);
